...
const components = {
  DnsItem1: defineAsyncComponent(() => import('./M/DNS/1.vue')),
  DnsItem2: defineAsyncComponent(() => import('./M/DNS/2.vue')),
  ExpItem1: defineAsyncComponent(() => import('./M/EXP/1.vue')),
  ExpItem2: defineAsyncComponent(() => import('./M/EXP/2.vue')),
}
