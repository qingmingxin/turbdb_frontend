the instant data can be read from the files via:
(nx,ny,nz should be adjusted for different casies)
    ...
    open(1,file="OCFDxxxxxxxx.dat",form="unformatted")
    read(1) Istep,tt
    do k=1,nz
        read(1) d(:,:,k)
    enddo
...
"Istep" = time step of the instant flow field
"tt" = time of the instant flow field
"d" = density
"u" = u-velocity
"v" = v-velocity
"w" = w-velocity
